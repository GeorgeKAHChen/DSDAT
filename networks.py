...
class CD_calc(nn.Module):
    def __init__(self, MAIN_PARAMETER, MAIN_DYNAMIC):
        ...
        self.runge_kutta = runge_kutta.runge_kutta(MAIN_DYNAMIC.delta_t, MAIN_DYNAMIC.f, MAIN_DYNAMIC.dim, MAIN_DYNAMIC.system_group[MAIN_DYNAMIC.para_change_loc],MAIN_PARAMETER.device)
